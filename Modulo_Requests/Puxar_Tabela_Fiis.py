...
tabela = site.find('div', attrs={'class': 'vd-automatic-tables cell medium-24 valor-data__mobile-break'})
print(slice(tabela))

'''tabelona.append(tabela)

print(tabelona)'''

'''news = pd.DataFrame(lista_noticias, columns=['principais','outras'])
print(news)'''